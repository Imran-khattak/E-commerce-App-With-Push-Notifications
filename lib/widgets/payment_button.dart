...
class PaymentButton extends StatefulWidget {
  const PaymentButton({super.key, this.enabled = false, this.width = 350});
...
class _PaymentButtonState extends State<PaymentButton>
  ...
  Widget _buildDollarIcon(
    ...
    Widget child = SizedBox(
      width: 60,
      child: Center(child: Image.asset('assets/dollar.png', width: 30)),
    );
    ...
    child = AnimatedContainer(
      ...
      decoration: BoxDecoration(
        color: status.isSuccess ? Utils.pacificblue : Color(0xFF2D3748),
...
class _AnimatedArrows extends StatefulWidget {
  const _AnimatedArrows({this.enabled = false});
